...
public class Homepage extends JFrame implements ActionListener{
     ...
     JLabel l1;
    JButton btnPatient, btnHistory,  btnInformation,  btnLogout;
  ...
  Homepage(){
   ...
   l1 = new JLabel("HOSPITAL MANGEMENT SYSTEM");
     ...
     btnHistory = new JButton ("Full History of the Patient");
     btnHistory.setVisible(true);
     btnHistory.setBounds(20, 400, 300, 75);
     btnHistory.setFont(new Font("Rockwell", Font.ITALIC,20));
     add(btnHistory);
     ...
     btnInformation.setBounds(20, 600, 300, 75);
     ...
     btnLogout.setBounds(20, 800, 300, 75);
